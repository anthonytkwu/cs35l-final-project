...
urlpatterns = [
    ...
    path('api/past_sessions/', PastSessionsView.as_view(), name='past-sessions'),
    path('api/past_sessions/<str:username>/', PastSessionsViewWith.as_view(), name='past-sessions-with'),
